    ...
    <div class="goods">
        ...
        <div class="menu-wrapper" ref="menuWrapper">
            <ul style="padding-inline-start:0px">
                <li v-for="(item,index) in goods" class="menu-item" :class="{'current':curentIndex===$index}"
    ...
    .goods
        ...
        .foods-wrapper
            ...
            .title
             ...
             height 26px;
             line-height 26px
             border-left 2 solid #d9ddel
             font-size 12px
             oclor rgb(147,153,159)
             background #f3f5f7
            .food-item
                display flex
                margin 18px
